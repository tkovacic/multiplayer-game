...
module.exports = {
	init: function(id, playerCount) {
		...
		self.img = {
				source:"../../client/img/player/alpha-still-l.png",
				frameIndex:0,
				tickCount:0,
		};
		...
		self.updateSpd = function() {
			if(self.pressingRight) {
				...
				self.status = 'running';
				self.right = true;
				self.img.source = "../../client/img/player/alpha-run-r.png";
			}else if(self.pressingLeft) {
				self.spdX = -self.maxSpd;
				self.status = 'running';
				self.right = false;
				self.img.source = "../../client/img/player/alpha-run-l.png";
			}else{
				self.spdX = 0;
				if(!self.pressingRight) {
					if(!self.pressingLeft) {
						self.status = 'standing';
						if(self.right == true) {
							self.img.source = "../../client/img/player/alpha-still-r.png";
						} else {
							self.img.source = "../../client/img/player/alpha-still-l.png";
						}
					}
				}
			}
