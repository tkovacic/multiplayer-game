	...
	this.init = function() {
		...
		socket.on('newPositions', function(data) { //whenever new positions are sent out
			...
			for(var i = 0; i < data.player.length; i++) { //foreach player in the game
				ctx.fillText(data.player[i].username, data.player[i].x + 40, data.player[i].y + 10); //remap usernames
				...
				if(data.player[i].status.localeCompare('running') == 0) {
					if(data.player[i].frame <= 0) { //if frame is 0
						ctx.drawImage(temp_img, 0, 0, 120, 120, data.player[i].x, data.player[i].y, 120, 120); //cut first half of sprite sheet
					} else if(data.player[i].frame == 1) {
						ctx.drawImage(temp_img, 120, 0, 120, 120, data.player[i].x, data.player[i].y, 120, 120); //cut second half of sprite sheet
					} else if(data.player[i].frame == 2) {
						ctx.drawImage(temp_img, 240, 0, 120, 120, data.player[i].x, data.player[i].y, 120, 120); //cut second half of sprite sheet
					} else if(data.player[i].frame == 3) {
						ctx.drawImage(temp_img, 360, 0, 120, 120, data.player[i].x, data.player[i].y, 120, 120); //cut second half of sprite sheet
					} else if(data.player[i].frame == 4) {
						ctx.drawImage(temp_img, 480, 0, 120, 120, data.player[i].x, data.player[i].y, 120, 120); //cut second half of sprite sheet
					} else if(data.player[i].frame == 5) {
						ctx.drawImage(temp_img, 600, 0, 120, 120, data.player[i].x, data.player[i].y, 120, 120); //cut second half of sprite sheet
					} else if(data.player[i].frame == 6) {
						ctx.drawImage(temp_img, 720, 0, 120, 120, data.player[i].x, data.player[i].y, 120, 120); //cut second half of sprite sheet
					} else if(data.player[i].frame >= 7) {
						ctx.drawImage(temp_img, 840, 0, 120, 120, data.player[i].x, data.player[i].y, 120, 120); //cut second half of sprite sheet
					}
